 ...
 *
 */
final class MustBeReachingDefUse extends
    DataFlowAnalysis<Node, MustBeReachingDefUse.MustDef> implements MyDefUse {
  ...
  static final class MustDef implements LatticeElement {
    ...
    public MustDef(Collection<Var> vars) {
      this();
      for (Var var : vars) {
        reachingDef.put(var, new Definition(var.getScopeRoot()));
      }
    }
   ...
   */
  private void addToDefIfLocal(String name, Node node,
      Node rValue, MustDef def) {
