...
class SanityCheckMaybe {

	@Test
	void test() {
		FileAnalyzer analyzer = new FileAnalyzer();
		Map<String, PolicyEntry> policy = analyzer.analyze("import * as newfs from 'fs'; if (true) var afs = require('fs'); afs.ab = 23; var sync = afs.readFileSync; sync();  require('child_process').execSync('ls'); require('./myFile'); function fct(){ var a = require('vm'); a.xy = 25; function xxx() {var fs = require('xfs'); afs.readFile(); fs.ab = 23; }; a.runInThisContext(); }; var bc = afs.exists;", true, false, false, false);
		System.out.println(FileAnalyzer.prettyPrint(policy));
